...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Counselor counselor1 = Counselor.builder().name("김가을").rating(4.8).counselingCount(17).reviewCount(8).counselingFields(new HashSet<>(Arrays.asList(CounselingField.DIVORCE, CounselingField.FORENSIC_SCIENCE))).build();
        Counselor counselor2 = Counselor.builder().name("김겨울").rating(4.1).counselingCount(30).reviewCount(19).counselingFields(new HashSet<>(Arrays.asList(CounselingField.FAMILY))).build();
